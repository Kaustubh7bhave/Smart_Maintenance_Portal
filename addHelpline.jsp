	...
	<section class="wrapper scrollable">
		...
		<div class="blank">
			<div class="content2">
				...
				<form action="addHelpline" method="post">
					...
					<input type="text" name="helplineName" value="helplineName" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'helplineName';}">
					<input type="text" name="helplineNumber" value="helplineName" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'helplineNumber';}">
