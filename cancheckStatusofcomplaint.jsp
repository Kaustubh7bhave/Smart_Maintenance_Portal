...
<body class="dashboard-page">
	...
	<nav class="main-menu">
		<ul>
			...
			<li class="has-subnav">
				...
				<span class="nav-text">
					your Complaint /Information with Department
				</span>
	...
	PreparedStatement s = con.prepareStatement("SELECT * FROM `complaint` WHERE `complaint1`='"+a+"'");
    ...
    %>
						...
						<tbody>
						  <tr>
						    ...
						    <td data-th="complain"><span class="bt-content"><%=rs.getString(6)%></span></td>
						  </tr>
						   <% }%>
						  						</tbody>
					  </table>
