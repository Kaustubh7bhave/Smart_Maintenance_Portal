...
Department</span>
	...
	<section class="wrapper scrollable">
		...
		<div class="blank">
			<div class="blank-page">
				...
				<h3>notification as per schedule added by admin</h3>
					    <table id="table">
						<thead>
						  <tr>
	...
	PreparedStatement s = con.prepareStatement("SELECT * FROM `roadmaintenance` WHERE `department`=? ");
    ...
    %>
						...
						<tbody>
						  <tr>
							...
							<td data-th="roadName"><span class="bt-content"><%=rs.getString(2) %></span></td>
							<td data-th="StartDate"><span class="bt-content"><%=rs.getString(3) %></span></td>
							<td data-th="ndDate"><span class="bt-content"> <%=rs.getString(4) %></span></td>
							<td data-th="DayOfWeek"><span class="bt-content"><%=rs.getString(5) %></span></td>
						  </tr>
						   <% }%>
						  						</tbody>
					  </table>
